	...
	public boolean recordReservation(int roomId, Date StartTime, Date EndTime, int orderId) {
		...
		try {
			...
			if (StartTime1 == null) {
				...
				sqlExpression3 = "update Room set OrderId1= " + String.valueOf(orderId) + " where RoomID=" + roomID
						+ ";";
				...
				sqlExpression3 = "update Room set OrderId2= " + String.valueOf(orderId) + " where RoomID=" + roomID
						+ ";";
				...
				sqlExpression3 = "update Room set OrderId3= " + String.valueOf(orderId) + " where RoomID=" + roomID
						+ ";";
				...
				sqlExpression3 = "update Room set OrderId4= " + String.valueOf(orderId) + " where RoomID=" + roomID
						+ ";";
			}
