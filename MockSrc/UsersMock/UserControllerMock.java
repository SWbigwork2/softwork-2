...
public class UserControllerMock {
    ...
    public ResultMessage addStaff(int id,String password,UserType type,String name
    ...
    public ResultMessage addMember(int id,String password,UserType type,String name){
